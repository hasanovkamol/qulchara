...
public interface IVoteService
{
    ...
    Task<(bool Success, string Message)> ConfirmVoteAsync(int adminId, string last3Digits, DateTime targetTime, TimeSpan timeWindow, CancellationToken cancellationToken = default);
