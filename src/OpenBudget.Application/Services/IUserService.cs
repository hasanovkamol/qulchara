...
public interface IUserService
{
    ...
    Task<(bool Success, string Message)> AssignRoleByIdentifierAsync(string identifier, UserRole newRole, UserRole assignerRole, CancellationToken cancellationToken = default);
